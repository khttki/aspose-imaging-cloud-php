...
*ImagingApi* | [**createDeskewedImageAsync**](ImagingApi.md#createdeskewedimageasync) | **POST** /imaging/deskew | Crop an image. Image data is passed as zero-indexed multipart/form-data content or as raw body stream.
...
*ImagingApi* | [**createImageFrameAsync**](ImagingApi.md#createimageframeasync) | **POST** /imaging/frames/{frameId} | Get separate frame from existing TIFF image. Image data is passed as zero-indexed multipart/form-data content or as raw body stream.
...
*ImagingApi* | [**getImageFrameAsync**](ImagingApi.md#getimageframeasync) | **GET** /imaging/{name}/frames/{frameId} | Get separate frame from existing TIFF image.
...
*ImagingApi* | [**getImageFramePropertiesAsync**](ImagingApi.md#getimageframepropertiesasync) | **GET** /imaging/{name}/frames/{frameId}/properties | Get separate frame properties of existing TIFF image.
